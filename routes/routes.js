...
router.get(
  "/PacienteCitas",
  AuthMiddleware.isLoggedAsP,
  controllers.userController.getCitasP
);
router.get(
  "/PacienteUpdate",
  AuthMiddleware.isLoggedAsP,
  controllers.userController.getUpdateP
);
router.post("/Paciente/Calc", controllers.userController.calcula);
router.get(
  "/Nutriologo",
  AuthMiddleware.isLoggedAsN,
  controllers.userController.getNutriPanel
);
router.get(
  "/Citas",
  AuthMiddleware.isLoggedAsN,
  controllers.userController.getNutriCitas
);
router.get(
  "/Alimentos",
  AuthMiddleware.isLoggedAsN,
  controllers.userController.getRegAli
);
